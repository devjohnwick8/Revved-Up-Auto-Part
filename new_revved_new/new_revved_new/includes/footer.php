...
<div class="footerSec">
  <div class="container">
    <div class="row">
      <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
        <div class="inner_foot footlogo">
          <a href="index.php"><img src="images/logo.png" alt="img" class="footerLogo" /></a>
        </div>
      </div>
      <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
      ...
      <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
        <div class="inner_foot">
          ...
          <ul class="linkList">
            ...
            <li><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">Radiator Modifications </a></li>
          </ul>
        </div>
      </div>
      <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        <div class="inner_foot none">
          <h5>Connect With Us</h5>
          <div class="social_icon">
            <ul>
              <li><a href="javascript:void(0)"><img src="images/f.png" class="img-fluid" alt=""></a></li>
              <li><a href="javascript:void(0)"><img src="images/p.png" class="img-fluid" alt=""></a></li>
              <li><a href="javascript:void(0)"><img src="images/i.png" class="img-fluid" alt=""></a></li>
            </ul>
          </div>
        </div> 
        <br>
        <div class="inner_foot none">
          ...
          <a href="javascript:void(0)"><img src="images/pay.png" class="img-fluid" alt=""></a>
        </div>
      </div>
    </div>
  </div>
  <div class="copy_right">
    <div class="container">
      <p>Copyrights &copy;2021 <a href="javascript:void(0)">revvedupautoparts.com</a> All rights reserved.</p>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <h4><a href="tel:8882973077"> <img src="images/ph.png" class="img-fluid" alt=""></a> Please call and speak to one of our representatives for any custom fabrication</h4>
          <div class="">
