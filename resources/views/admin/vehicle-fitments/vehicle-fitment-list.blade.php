...
<div class="py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Vehicle-Fitments</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">Vehicle Fitments List</h1>
        </div>
        <div>
            <a href="{{route('admin_vehicle_fitments_add')}}" class="btn btn-outline-gray"><i class="far fa-plus-square mr-1"></i> Add New Vehicle Fitment</a>
        </div>
    </div>
</div>
                    ...
                    <!-- Item -->
                        ...
                        @foreach($vehicle_fitment as $key=>$value)
                            <tr>
                                ...
                                <td class="border-0">
                                    <a href="{{route('admin_vehicle_fitments_edit').'/'.$value->id}}" class="text-secondary mr-3"><i class="fas fa-edit"></i>Edit</a>
                                    <span class="text-primary"> |  </span>
                                    <a href="{{route('admin_vehicle_fitments_delete').'/'.$value->id}}" class="text-danger ml-3"><i class="far fa-trash-alt"></i>Delete</a>
                                </td>
                            </tr>
                        @endforeach
                        <!-- End of Item -->
