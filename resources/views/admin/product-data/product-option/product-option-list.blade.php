...
<div class="py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Product Option</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">Product-Option</h1>
        </div>
        <div>
            <a href="{{route('admin_product_option_add')}}" class="btn btn-outline-gray"><i class="far fa-plus-square mr-1"></i> Add New Product Option</a>
        </div>
    </div>
</div>
            ...
            <table class="table table-centered table-nowrap mb-0 rounded" id="table_id">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-0">
                            <a href="{{route('admin_product_option_edit_new',[$value->get_available->id])}}" class="text-secondary mr-3"><i class="fas fa-edit"></i>Edit</a>
                            <span class="text-primary"> | </span>
                            <a href="{{route('admin_product_option_delete',[$value->get_available->id])}}" class="text-danger ml-3"><i class="far fa-trash-alt"></i>Delete</a>
                        </td>
                    </tr>
                    @endforeach
                    <!-- End of Item -->
