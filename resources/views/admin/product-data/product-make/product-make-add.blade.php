    ...
    <div class="py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Product-Make-Add</li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Product Make Add</h1>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-lg-12 col-sm-12">
                                ...
                                @endif
                                <form action="{{route('admin_product_make_add_edit_data')}}" method="POST" enctype="multipart/form-data">@csrf
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <div class="mb-4">
                                                <label for="title">Product Make</label>
                                                <input type="text" class="form-control" required name="title" placeholder="Enter your product make...">
                                            </div>
                                        </div>
