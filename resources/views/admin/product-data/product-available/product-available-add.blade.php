...
<div class="py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Product-Available-Add</li>
    </ol>
    </nav>
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">Product Available Add</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <form action="{{route('admin_product_available_add_edit_data')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row input_fields_wrap">
                                <div class="col-sm-5">
                                        <div class="mb-4">
                                            <label for="title">Heading</label>
                                            <input type="text" class="form-control" data-id="1" required name="heading" placeholder="Enter your heading">
                                        </div>
                                    </div>
                                                ...
                                                '<div class = "row input_fields_wrap" > ' +
                                                    ...
                                                    '<div class ="col-sm-4" > ' +
                                                        '<div class="mb-4">' +
                                                            ...
                                                            '<input type="number" class="form-control" required name="amount[]"  placeholder="Enter your Price">' +
                                                        '</div>'+
                                                    '</div>' +
