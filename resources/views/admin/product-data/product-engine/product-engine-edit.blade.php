                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-lg-12 col-sm-12">
                                ...
                                @endif
                                <form action="{{route('admin_product_engine_add_edit_data',[$product_engine->id])}}" method="POST" enctype="multipart/form-data">@csrf
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <div class="mb-4">
                                                <label for="title">Product Engine</label>
                                                <input required type="text" class="form-control" value="{{$product_engine->title}}" required name="title" placeholder="Enter your product engine...">
                                            </div>
                                        </div>
