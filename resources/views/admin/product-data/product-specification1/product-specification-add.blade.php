                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <form action="{{route('admin_product_specification_add_edit_data')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row input_fields_wrap">
                                    <div class="col-sm-4">
                                        <div class="mb-4">
                                            <label for="title">Title</label>
                                            <input type="text" class="form-control" data-id="1" required name="spec_head[]" placeholder="Enter your product Title...">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="mb-4">
                                            <label for="title">Detail</label>
                                            <input type="text" class="form-control" data-id="1" required name="spec_detail[]" placeholder="Enter your product Detail...">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
