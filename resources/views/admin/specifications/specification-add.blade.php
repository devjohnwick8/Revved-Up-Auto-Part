...
<div class="py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Specification-Add</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">Specification Add</h1>
        </div>
    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-12 col-sm-12">
                            <!-- Form -->
                                ...
                                @endif
                            <form action="{{route('admin_specifications_add_edit')}}" method="POST" enctype="multipart/form-data">@csrf
                                <div class="mb-4">
                                ...
                                <div>
                                    <!-- <label for="textarea">Specification Image</label> -->
