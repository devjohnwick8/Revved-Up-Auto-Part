...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        ...
        <div>
            <a href="{{route('admin_products_add')}}" class="btn btn-outline-gray"><i
                    class="far fa-plus-square mr-1"></i> Add New Product</a>
        </div>
    </div>
</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-0">
                            ...
                            <img class="img-list"
                                src="{{$value->images_take1 ? asset('uploads/products/'.$value->images_take1->title) : ''}}"
                                alt="{{$value->title}}">
                        </td>
                        <td class="border-0 font-weight-bold">
                            <span
                                class="{{$value->status == 1 ? 'text-success' : 'text-danger'}}">{{$value->status == 1 ? 'Active' : 'Inactive'}}</span>
                        </td>
                        <td class="border-0">
                            <a href="{{route('admin_products_edit').'/'.$value->id}}" class="text-secondary mr-3"><i
                                    class="fas fa-edit"></i>Edit</a>
                            <span class="text-primary"> | </span>
                            <a href="{{route('admin_products_delete').'/'.$value->id}}" class="text-danger ml-3"><i
